...
export const MetricsSelection: React.FC<MetricsSelectionProps> = ({
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="space-y-4">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="flex items-start space-x-4 p-4 border-b border-gray-100 dark:border-gray-700 last:border-b-0 animate-pulse">
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Single scrollable card containing all metric categories */}
            ...
            return (
              <div
                ...
                className={`transition-all duration-200 ${
                  index !== metricCategories.length - 1 ? 'border-b border-gray-200 dark:border-gray-700' : ''
                } ${category.selected ? 'bg-indigo-50 dark:bg-indigo-900/20' : 'hover:bg-gray-50 dark:hover:bg-gray-700/50'}`}
              >
                {/* Category Header */}
                <div
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-4">
                      <div className={`w-12 h-12 rounded-lg flex items-center justify-center text-xl ${colorClasses.icon} bg-gray-100 dark:bg-gray-700`}>
                        {category.icon}
                      </div>
                      <div className="flex-1">
                ...
                {/* Sub-metrics */}
                {category.selected && (
                  <div className="border-t border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 px-6 pb-6 pt-4 space-y-3">
